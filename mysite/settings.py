...
DATABASES = {
    'default': {
        ...
        'NAME': 'pythonDB',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/sevenbits/projects/python/mysite/media'
...
SECRET_KEY = '*xmbkj3_(9$e9&dg)sacb7oxog^393l$+jum9x#o0qq$4kqrs='
